...
train_loader, test_loader = get_medmnist_dataloader_open_clip(dataset_classes[10], preprocess_train, preprocess_val, batch_size=32, download=True)
#
...
classifier = nn.Linear(512, 11).to(device)
...
best_f1 = 0
best_accuracy = 0
best_model_path = "organSmnist_ViT_B_16_clip_model.pth"
...
import json
with open("organSmnist_ViT_B_16_clip_metrics.json", "w") as f:
    json.dump(metrics, f)

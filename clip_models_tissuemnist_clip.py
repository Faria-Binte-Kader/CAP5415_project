...
train_loader, test_loader = get_medmnist_dataloader_open_clip(dataset_classes[11], preprocess_train, preprocess_val, batch_size=32, download=True)
#
...
classifier = nn.Linear(512, 8).to(device)
...
best_f1 = 0
best_accuracy = 0
best_model_path = "tissuemnist_ViT_B_16_clip_model.pth"
...
import json
with open("tissuemnist_ViT_B_16_clip_metrics.json", "w") as f:
    json.dump(metrics, f)

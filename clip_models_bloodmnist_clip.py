...
train_loader, test_loader = get_medmnist_dataloader_open_clip(dataset_classes[0], preprocess_train, preprocess_val, batch_size=32, download=True)
#
...
best_f1 = 0
best_accuracy = 0
best_model_path = "bloodmnist_ViT_B_16_clip_model.pth"
...
import json
with open("bloodmnist_ViT_B_16_clip_metrics.json", "w") as f:
    json.dump(metrics, f)

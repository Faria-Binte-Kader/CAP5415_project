...
# Load the JSON file
with open("pathmnist_ViT_B_16_clip_metrics.json", "r") as file:
    data = json.load(file)
...
plt.title("PathMNIST Accuracy Score Across Epochs")
plt.xlabel("Epoch")
plt.ylabel("Score")
plt.legend()
plt.grid(True)
plt.savefig("pathmnist_acc_metrics_plot.png")  # Save the plot
plt.close()
...
plt.title("PathMNIST F1 Score Across Epochs")
plt.xlabel("Epoch")
plt.ylabel("Score")
plt.legend()
plt.grid(True)
plt.savefig("pathmnist_f1_metrics_plot.png")  # Save the plot
plt.close()
